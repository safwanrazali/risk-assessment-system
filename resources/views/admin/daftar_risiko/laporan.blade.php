...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="mb-0">Laporan Risiko</h5>
    <div class="btn-group">
        <a href="{{ route('admin.laporan.risiko.download-csv') }}" class="btn btn-success">
            <i class="bi bi-download me-1"></i> CSV
        </a>
        <a href="{{ route('admin.laporan.risiko.download-pdf') }}" class="btn btn-danger">
...
<div class="card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group btn-group-sm">
            <a href="{{ route('admin.laporan.risiko.download-agency-csv') }}" class="btn btn-success" title="Download CSV">
                <i class="bi bi-filetype-csv"></i>
            </a>
            <a href="{{ route('admin.laporan.risiko.download-agency-pdf') }}" class="btn btn-danger" title="Download PDF">
...
<div class="card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group btn-group-sm">
            <a href="{{ route('admin.laporan.risiko.download-asset-csv') }}" class="btn btn-success" title="Download CSV">
                <i class="bi bi-filetype-csv"></i>
            </a>
            <a href="{{ route('admin.laporan.risiko.download-asset-pdf') }}" class="btn btn-danger" title="Download PDF">
                <i class="bi bi-file-earmark-pdf"></i>
            </a>
        </div>
    </div>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group btn-group-sm">
            <a href="{{ route('admin.laporan.risiko.download-detail-csv') }}" class="btn btn-success" title="Download CSV">
                <i class="bi bi-filetype-csv"></i>
            </a>
            <a href="{{ route('admin.laporan.risiko.download-detail-pdf') }}" class="btn btn-danger" title="Download PDF">
                <i class="bi bi-file-earmark-pdf"></i>
            </a>
        </div>
    </div>
