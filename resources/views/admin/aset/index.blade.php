                ...
                <tbody>
                    @forelse($items as $item)
                        <tr>
                            ...
                            <td>{{ $item->jenisAset->nama }}</td>
                            <td>{{ $item->nama_aset }}</td>
                            <td class="text-end">
                                <a href="{{ route('admin.aset.edit', $item) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
                                <form action="{{ route('admin.aset.destroy', $item) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
